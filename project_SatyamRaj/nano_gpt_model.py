...
"""
nanoGPT-like GPT Language Model (with full nanoGPT features!)
"""
...
class NanoGPTConfig:
    block_size: int = 256
    vocab_size: int = 65  # Shakespeare char-level vocab
    n_layer: int = 6
    n_head: int = 6
    n_embd: int = 384
    dropout: float = 0.2
...
class NanoGPT(nn.Module):
    def __init__(self, config):
        ...
        print(f"nanoGPT-like model created with {self.get_num_params()/1e6:.2f}M parameters", flush=True)
    ...
    def configure_optimizers(self, weight_decay, learning_rate, betas, device_type):
        # Just like real nanoGPT! Separate params that do/don't get weight decay
